          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-8 sm:pt-12 pb-6 grid grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div>
              ...
              <a
                ...
                className="inline-flex items-center gap-2.5 text-sm text-white transition-colors group"
              >
                <span className="w-8 h-8 rounded-lg bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 flex items-center justify-center shrink-0">
